...
register_model("PoissonRegressor", PoissonRegressorModel)
register_model("PolynomialRegression", PolynomialRegressionModel)
register_model("FactorAnalysis", FactorAnalysisModel)
register_model("CCA", CCAModel)
register_model("LabelPropagation", LabelPropagationModel)
register_model("SelfTrainingClassifier", SelfTrainingClassifierModel)
register_model("CoxPH", CoxPHModel)
register_model("Anova", AnovaModel)
register_model("Manova", ManovaModel)
register_model("MixedEffects", MixedEffectsModel)
register_model("StructuralEquation", StructuralEquationModel)
